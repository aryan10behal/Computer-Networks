...
void read_file(char whole_file[10000], char path[1000])
{
...
char file_name[1000];
 ...
 fgets(whole_file, 10000, fptr);

 fclose(fptr);
}


void work_with_processes(char whole_file[10000], short unsigned int path_val, char buffer[1024])
{
    // path for file
    char path[1000];
